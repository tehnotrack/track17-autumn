...
import ru.track.prefork.argparser.HelpOptions;
import ru.track.prefork.argparser.HelpParser;
...
public class Server {
    ...
    private class AdminConsole {
        ...
        private void drop(String[] arguments) {
            Option[] options = {
                    Option.builder("i").longOpt("client-id").desc("The client id to drop.").argName("CLIENT_ID")
